	...
	render(){
		...
		return <div className="appContainer">
					...
					<div className="wrapperViews">
						...
						<Route path="/informacion-empresa" render={(props) => (<EnterpriseInformationForm user={this.state.user} sendEnterpriseInformation={this.sendEnterpriseInformation} enterpriseInProcessData={this.state.enterpriseInProcessData} enterpriseInProcess={this.state.enterpriseInProcess} enterpriseSaved={this.state.enterpriseSaved} updateEnterpriseInformation={this.updateEnterpriseInformation}/>)   }/>
						<Route path="/invitar-socios" render={(props)=>(<PartnersAddingForm user={this.state.user} sendPartnerInvitation={this.sendPartnerInvitation} enterpriseInProcessData={this.state.enterpriseInProcessData} rowPartnerInputHandler={this.rowPartnerInputHandler} deletingPartnerRow={this.deletingPartnerRow} rowAccountManagerInputHandler={this.rowAccountManagerInputHandler} partnersInvitationSaved={this.state.partnersInvitationSaved} updatePartnerInvitation={this.updatePartnerInvitation}/> )   }/>
						<Route path="/informacion-personal" render={(props)=>(<PersonalInformationForm user={this.state.user} enterpriseInProcessData={this.state.enterpriseInProcessData} inputTextHandler={this.inputTextHandler} selectHandler={this.selectHandler} rowInputsHandler={this.rowInputsHandler} deleteRowInputHandle={this.deleteRowInputHandle} sendPartnersInformation={this.sendPartnersInformation} enterpriseSaved={this.state.enterpriseSaved}/> )    }/>
						<Route path="/fecha-firma" render={(props)=>(<DateForm inputTextHandlerRootLevel={this.inputTextHandlerRootLevel} enterpriseInProcessData={this.state.enterpriseInProcessData} insertDataRootLevel={this.insertDataRootLevel} sendSingingDateInformation={this.sendSingingDateInformation} enterpriseSaved={this.state.enterpriseSaved}/>)    }/>
						<Route path="/seleccion-metodo-pago" onUpdate={this.logPageView} render={(props)=>( <SelectPaymentMethodForm enterpriseInProcessData={this.state.enterpriseInProcessData} enterpriseSaved={this.state.enterpriseSaved}/>)    }/>
						<Route path="/metodo-pago-voucher" onUpdate={this.logPageView} render={(props)=>( <PaymentMethodForm enterpriseInProcessData={this.state.enterpriseInProcessData} enterpriseSaved={this.state.enterpriseSaved}/>)    }/>
						<Route path="/perfil" onUpdate={this.logPageView} render={(props)=>(<Userprofile user={this.state.user} isItLogin={this.isItLogin}/>) }/>
